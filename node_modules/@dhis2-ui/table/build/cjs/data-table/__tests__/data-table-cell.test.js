...
describe('<DataTableCell>', () => {
  ...
  it('can render either a td or th tag depending on the fixed and tag prop', () => {
    // default
    expect((0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_dataTableCell.DataTableCell, null)).dive().type()).toBe('td'); // using the tag prop
    ...
    expect((0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_dataTableCell.DataTableCell, {
      tag: "th"
    })).dive().type()).toBe('th'); // with fixed prop

    expect((0, _enzyme.shallow)( /*#__PURE__*/_react.default.createElement(_dataTableCell.DataTableCell, {
      fixed: true
    })).dive().type()).toBe('th'); // tag prop should take presedence over fixed prop
