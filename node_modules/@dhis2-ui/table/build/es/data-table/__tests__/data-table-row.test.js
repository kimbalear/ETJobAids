...
describe('<DataTableRow>', () => {
  ...
  it('accepts an expandableContent prop', () => {
    ...
    const additionalRowTag = wrapper.find(ExpandedRow).dive().find(TableRow).dive().find('tr'); // render expandableContent in additional row

    expect(additionalRowTag).toHaveLength(1); // Hover styles

    additionalRowTag.simulate('mouseover');
    expect(wrapper.find(TableRow).dive().find('tr').hasClass('isHoveringExpandedContent')).toBe(true);
